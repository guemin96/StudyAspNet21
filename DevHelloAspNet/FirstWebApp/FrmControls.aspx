...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="LnkMicrosoft" NavigateUrl="https://www.microsoft.com" runat="server" text="마이크로소프트" />
            ...
            <asp:ListBox ID="LsbHobby" runat="server" Height="19px" Width="47px">
